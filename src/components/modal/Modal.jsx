...
const Modal = ({
  ...
  const handelAddClient = async () => {
    if (!addClient.clientUserName) {
      toast.error("Enter Client UserName");
    } else if (!addClient.clientNickName) {
      toast.error("Enter Client NickName");
    } else if (!addClient.password) {
      toast.error("Enter Client Password");
    } else {
      try {
        setLoad(true);
  ...
  const handelAddCredit = async (clientUserName, type) => {
    ...
    if (!credit) {
      toast.error(`Enter ${type === "redeem" ? "Redeem" : "Credit"} Value`);
  ...
  return (
    modal && (
      <>
        <div
          className={`fixed ${
            modal ? "scale-100 transition-all" : "scale-50 transition-all"
          } z-50 top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-white w-[50%] p-5 rounded-lg`}
        >
          <div
          ...
          {type === "recharge" && (
            <div>
              <div>
                Username : <span>{clientData?.username}</span>
              </div>
              <div className="pt-5">
                <div>
                  <label
                ...
                <div className="flex justify-center pt-5">
                  <button
                    onClick={() => handelAddCredit(clientData?.username)}
                    type="button"
            ...
            <div>
              ...
              <div className="pt-5">
                ...
                <div className="flex justify-center pt-5">
                  <button
                    onClick={() =>
                      handelAddCredit(clientData?.username, "redeem")
                    }
                    type="button"
                    className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                  >
              ...
              <table className="w-full">
                <thead>
                  ...
                  <tr className="text-center py-2">
                    ...
                    <td>
                      {Math.round(
                        (clientData?.credits / clientData?.totalRecharged) * 100
                      )
                        ? Math.round(
                            (clientData?.credits / clientData?.totalRecharged) *
                              100
                          )
                        : 0}
                      %
            ...
            <div>
              <div className="pt-5">
                <div className="text-center text-black font-semibold">
                  Are You Want to Delete to {clientData?.username}?
                </div>
                <div className="flex items-center  justify-center pt-10 space-x-10">
                  <button
                    onClick={() => handelDelete(clientData?.username)}
                    type="button"
              ...
              <div className="pt-5 space-y-3">
                <div>
                  ...
                  <input
                    ...
                    value={addClient.clientUserName}
                    name="clientUserName"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    id="NickName"
                    onChange={(e) => handelClientChange(e)}
                    value={addClient.clientNickName}
                    name="clientNickName"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              <div className="pt-5 space-y-3 ">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <label
                      for="fileUpload"
                      className="cursor-pointer bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-20 rounded"
                    >
                      Upload File
                    </label>
                    <p id="fileName" className="flex mt-4">
                      {gamethumbnail && (
                        <Image
                          src={URL.createObjectURL(gamethumbnail)}
                          alt="img"
                          width={200}
                          height={10}
                          className="mr-4"
                      ...
                      {EditGameData?.gameThumbnailUrl && (
                        <Image
                          src={EditGameData?.gameThumbnailUrl}
                          alt="img"
                          width={200}
                          height={10}
                          className="mr-4"
                      ...
                      {games.gameThumbnailUrl && (
                        <svg
                          ...
                          stroke-linecap="round"
                          stroke-linejoin="round"
                          className="lucide bg-green-600 text-white rounded-full p-1 lucide-circle-check-big"
                        >
                ...
                <div>
                  ...
                  <input
                    type="text"
                    onChange={(e) => handelGameChange(e)}
                    value={games.gameHostLink}
                    name="gameHostLink"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="game host link"
                    required
                  />
                </div>
                <div>
                ...
                {type === "updateGame" && (
                  <label className="inline-flex items-center cursor-pointer">
                    ...
                    />
                    <div
                      className={`relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-green-300 dark:peer-focus:ring-green-800 rounded-full peer dark:bg-red-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-green-600`}
                    ></div>
          ...
          {type === "deleteGame" && (
            <div>
              <div className="pt-5">
                <div className="text-center text-black font-semibold">
                  Are You Want to Delete This Game?
                </div>
                <div className="flex items-center  justify-center pt-10 space-x-10">
                  <button
                    onClick={() => handelDeleteGame(type, deletegame_id)}
                    type="button"
                    className="text-white inlin bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
                  >
                    Yes
                  </button>
                  <button
                    onClick={() => handelClosemodal(false)}
                    type="button"
                    className="text-white inline-block border bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
                  >
                    No
                  </button>
                </div>
        ...
        <div
          onClick={() => handelClosemodal(false)}
          className="bg-black transition-all bg-opacity-40 w-full h-screen fixed top-0 left-0"
        ></div>
        <Loader show={load} />
      </>
    )
