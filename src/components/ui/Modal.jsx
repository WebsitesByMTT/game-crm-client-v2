  ...
  return (
    <>
      {open && (
        ...
        >
          <div className=" border-[1.5px] border-[#dfdfdf2e]  relative m-auto w-[90%] sm:w-[40%] animate-scale h-auto sm:min-w-[500px] bg-[#F3F4F6] dark:bg-[#1a1a1a] rounded-md py-8 text-lg p-4 dark:text-white">
            <div className="flex -mt-3 justify-between items-start pb-4 mb-4 border-[#dfdfdf23] border-b-[1px]">
              <p className="text-left dark:text-white text-black  text-2xl font-medium drop-shadow-sm  ">
                {modalType}
              </p>
              <button
