...
const LeftSideBar = ({ text, data }) => {
    ...
    return (
        <div className='py-20 rounded-xl bg-[#0F0F0F] px-2 md:px-10 flex flex-col justify-between border h-full'>
            <div>
                ...
                {data?.designation==='company'&&<div className='mt-5 text-center text-white rounded-3xl cursor-pointer bg-indigo-600'>
