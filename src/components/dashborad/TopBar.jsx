...
const TopBar = ({ data }) => {
  ...
  const checkboxfilter = useSelector(
    (state) => state.globlestate.CheckBoxFilter
  );
    ...
    <div className="p-2 h-full rounded-2xl">
      <div className=" h-full bg-[#161616] rounded-2xl">
        <div className="py-5 bg-gradient-to-r  px-2   lg:px-10">
          <div className="lg:flex items-center space-y-5 lg:space-y-0 justify-between w-full">
            ...
            <div className=" text-white cursor-pointer">
              <div className="relative">
                ...
                <div
                  className={`${
                    toggle ? "scale-100 transition-all" : "scale-0 "
                  } space-y-3 absolute rounded-sm top-[100%] w-[200px] px-5 py-2 right-0 bg-white`}
                >
                  <div
                    className={`flex  ${
                      checkboxfilter === "all"
                        ...
                        : "text-black"
                    }  py-1  rounded-lg cursor-pointer justify-around`}
                  >
                    <label className="cursor-pointer">
                      All
                      <input
                        onChange={() => dispatch(CheckBoxFilter("all"))}
                        type="radio"
                        name="account_filter"
                        className="hidden"
                      />
                  ...
                  >
                    <label className="cursor-pointer">
                      Active
                      <input
                        onChange={() => dispatch(CheckBoxFilter("active"))}
                        type="radio"
                        name="account_filter"
                        className="hidden"
                      />
                  ...
                  >
                    <label className="cursor-pointer">
                      Inactive
                      <input
                        onChange={() => dispatch(CheckBoxFilter("inactive"))}
                        type="radio"
                        name="account_filter"
                        className="hidden"
                      />
          ...
          <div className="space-y-5 lg:space-y -0 lg:flex items-center justify-between pt-5">
            <div className="space-y-3 ">
              <div className="text-indigo-500">
                Account :{" "}
                <span className="text-white capitalize">{data?.username}</span>
              </div>
              <div className="text-indigo-500">
                Credits :{" "}
                <span className="text-white">
                  {data && data.designation === "company"
                    ? "Infinite"
                    : Math.round(data?.credits)}
                </span>
              </div>
            </div>
            {clientdata?.username && (
              <div className="text-white">
                ...
                <span className="pl-2 capitalize font-bold">
                  {clientdata?.username}
                </span>
              </div>
            )}
            <button
              onClick={() => handelModal(true, "add_client")}
              type="button"
          ...
          {/* Button  */}
          {clientdata?.username && (
            <div className="flex flex-wrap lg:justify-around lg:items-center pt-10">
              <button
                onClick={() => handelModal(true, "delete")}
                type="button"
              ...
              <button
                onClick={() => handelModal(true, "recharge")}
                type="button"
              ...
              <button
                onClick={() => handelModal(true, "redeem")}
                type="button"
                className="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-indigo-800"
              >
                Redeem
              ...
              <button
                onClick={() => handelModal(true, "update_password")}
                type="button"
                className="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-indigo-800"
              >
                Update Password
              ...
              <button
                onClick={() => handelModal(true, "transaction")}
                type="button"
                className="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-indigo-800"
              >
                Transaction
              ...
              <button
                onClick={() => handelModal(true, "report")}
                type="button"
                className="text-white bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 focus:outline-none dark:focus:ring-indigo-800"
              >
                Report
