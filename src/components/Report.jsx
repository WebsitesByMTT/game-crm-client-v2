  ...
  return (
    <div className="flex flex-col h-full py-4">
      <div className="flex items-center justify-between mt-2">
        <h5 className="text-2xl dark:text-white font-medium">
          {reportType} Report
        </h5>
        <select
          id="reportType"
      ...
      <div className="flex flex-col">
        ...
        <div className="flex w-full m-auto flex-col xl:flex-row xl:justify-between gap-5 h-auto">
          <div className="w-full h-fit bg-white rounded-xl dark:bg-Dark_light py-5 px-6 relative">
            ...
            <div
              className={`${
                ...
                Object.values(data.users).every((value) => value === 0)
                  ? "h-fit"
                  : "h-[35vh] lg:h-[56vh] lg:min-h-[480px]"
              } w-full xl:w-[50%] bg-white dark:bg-Dark_light rounded-xl px-6 py-5 h-auto`}
            >
  ...
  return (
    <div className="w-[95%] mx-auto rounded-xl p-2 border-[1px] bg-[#dfdfdf2a] border-[#dfdfdf38] dark:bg-[#1515157a]">
      <div className="w-full flex flex-col xl:flex-col xl:gap-1  2xl:flex-row justify-between h-full overflow-hidden">
        <div className="flex flex-col text-md w-fit justify-evenly dark:text-white overflow-hidden gap-1">
