...
const UserLogin = () => {
  ...
  const handleLogin = async () => {
    ...
    if (!validateCaptcha(captcha)) {
      return toast("Invalid Captcha", { type: "error" });
    }
    setLoad(true);
    try {
        ...
        <div className="bg-white w-[90%] md:w-[50%] lg:w-[40%] 2xl:w-[30%] rounded-md p-5 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
          ...
          <div className="w-[90%] space-y-10 mx-auto pt-8">
            ...
            <div className="flex justify-center">
              <button
                onClick={handleLogin}
                className="text-center w-[60%] mx-auto text-white text-xl rounded-md py-2 font-semibold bg-gradient-to-r hover:from-cyan-500 hover:to-blue-500 transition-all to-cyan-500 from-blue-500"
              >
                LOGIN
              </button>
            </div>
